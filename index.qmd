...
# Function to create custom CV plot
...
Next was performing Cross-Validation for the ridge regression to find the optimal parameter for the penalty term.
